...
############import data 0226###########
Odata <- read_csv("/Users/cpf/OneDrive - bjtu.edu.cn/cpf/paper_writting/NHTSA/data/Output_fars/dftwo0226.csv")
...
### 数据
write.csv(
  Mdata1, file = "/Users/cpf/OneDrive - bjtu.edu.cn/cpf/paper_writting/NHTSA/data/Output_fars/outputr/Mdata1.csv", 
...
eq1<- DIE ~ AGE + SEX + REST_USE + DR_DRINK + DRUGS + AIR_BAG + EJECTION + EXTRICAT + DOA + ROLLOVER + TIME + BODY_TYP + WEATHER + MAN_COLL + LGT_COND 
eq2 <- DIE_ ~  DIE + AGE_ + SEX_ + REST_USE_ + DR_DRINK_ + DRUGS_ + AIR_BAG_ + EJECTION_ + EXTRICAT_ + DOA_+ ROLLOVER_ + TIME + BODY_TYP_+ WEATHER + MAN_COLL + LGT_COND
f.list <- list(eq1, eq2)
